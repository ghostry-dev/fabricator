...
:::warning
`@ghostry/fabricator` is at version `0.0.0` and has not been published yet. `bun add @ghostry/fabricator` will not resolve until a first release ships. This page documents how installation will work once it does.
:::
