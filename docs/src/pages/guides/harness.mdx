...
Every test body runs inside [`instance.wrap(...)`](/guides/reproducibility#making-a-fork-ambient-wrap) with its identity [layered](/guides/reproducibility#composing-instead-of-replacing-layer) onto the instance salt:
