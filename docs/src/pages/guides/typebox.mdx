:::warning
The TypeBox adapter described on this page lives in its own package, `pkg/fabricator-adapter-typebox-v0` in this repo, but hasn't published a first release yet. Treat the imports below as aspirational until it does.
:::
