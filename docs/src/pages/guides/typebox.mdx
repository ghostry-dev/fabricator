:::warning
The TypeBox adapter described on this page lives in its own package, `pkg/fabricator-adapter-typebox-v0` in this repo, but isn't published yet — publishing is disabled repo-wide. Treat the imports below as aspirational until a release ships.
:::
